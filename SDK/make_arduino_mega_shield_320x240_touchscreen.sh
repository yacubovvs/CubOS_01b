...
cat src/cubos.ino                                               >> build/arduino/mega_shield_240x320_touchscreen/cubos/cubos.ino
...
#   APPS CONFIG
cp src/apps/os_applications_mega2560_touch.ino                  build/arduino/mega_shield_240x320_touchscreen/cubos/

cp src/apps/app_clock.ino                                       build/arduino/mega_shield_240x320_touchscreen/cubos/
cp src/apps/app_sdcard_manager.ino                              build/arduino/mega_shield_240x320_touchscreen/cubos/
...
cp src/os_*.ino                                                 build/arduino/mega_shield_240x320_touchscreen/cubos/
...
cp -R src/libs_h                                                build/arduino/mega_shield_240x320_touchscreen/cubos/

echo "Mega 2560 touch screen 240x320 arduino project generate DONE"