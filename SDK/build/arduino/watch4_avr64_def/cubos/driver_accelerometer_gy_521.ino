...
void accelerometer_loop()
{
  ...
  //drawDebugString(accel_t_gyro.value.temperature *100, 10); 
  drawDebugString(accel_t_gyro.value.y_gyro, 18); 
  drawDebugString(accel_t_gyro.value.z_gyro, 26);
  
  drawDebugString(accel_t_gyro.value.x_accel, 40); 
  drawDebugString(accel_t_gyro.value.y_accel, 48); 
  drawDebugString(accel_t_gyro.value.z_accel, 56);  
