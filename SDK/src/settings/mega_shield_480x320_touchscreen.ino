...
#define SCREEN_HEIGHT           480     // Note: y-coordinates go high
...
#define MAX_RAM_SIZE_FOR_B_APPS 255 //in bytes RAM for applications from sd card
...
//#define debug
//#define debug_show_touch_position
